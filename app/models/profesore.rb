class Profesore < ApplicationRecord
    ...
    validates :PROFE_EMAIL , format: { :with => VALID_EMAIL_REGEX , message: "El formato del correo es invalido" }
        #Validamos que los campos se ingresen.
    validates :PROFE_NOMBRE, :PROFE_EMAIL, :PROFE_ROL, :presence => {:message => "Campo esta en blanco." }
end
